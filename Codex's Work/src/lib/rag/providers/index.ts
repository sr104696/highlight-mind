...
export const RemoteProvider: EmbeddingProvider = {
  async embedTexts() { throw new Error("RemoteProvider not configured"); },
  async embedQuery() { throw new Error("RemoteProvider not configured"); },
  async rerank() { throw new Error("RemoteProvider not configured"); },
};
